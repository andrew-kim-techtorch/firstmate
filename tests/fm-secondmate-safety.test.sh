...
test_fm_home_parameterization() {
  ...
  FM_HOME="$home_one" FM_GUARD_GRACE=999999 FM_PR_CHECK_SKIP_BODY_GATE=1 "$ROOT/bin/fm-pr-check.sh" task-a https://github.com/example/repo/pull/1 >/dev/null 2>/dev/null \
