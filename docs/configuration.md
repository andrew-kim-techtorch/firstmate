...
FM_MMDC_TIMEOUT_SECS=30   # seconds allowed per real-parser mermaid call (mmdc or the npx mermaid-cli fallback) in fm-pr-body-check.sh before the timeout guard downgrades to a warning; a cold npx cache may need a larger value
